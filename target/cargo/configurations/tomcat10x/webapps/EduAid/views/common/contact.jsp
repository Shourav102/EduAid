...
<main class="contact-main">
  ...
  <div class="contact-body">
    ...
    <div class="contact-left">
      ...
      <div class="info-card">
        ...
        <div class="info-card-content">
          <h4>Visit Us</h4>
          <p>Islington College<br>Kamalpokhari, Kathmandu<br>Nepal, 44600</p>
        </div>
      </div>
      <div class="info-card">
        <div class="info-card-icon">🌐</div>
    ...
    <div class="faq-inner">
      ...
      <div class="faq-list">
        ...
        <div class="faq-item">
          ...
          <div class="faq-answer">Anyone can register as a Donor — including students, teachers, parents, or organisations. Once your account is approved, you can start listing educational resources such as books, stationery, lab equipment, and digital media.</div>
        </div>
        <div class="faq-item">
        ...
        <div class="faq-item">
          ...
          <div class="faq-answer">EduAid currently supports five categories: Books, Stationery, Lab Equipment, Digital Media, and Sports & Arts supplies. We plan to expand these categories in the future to cover more educational needs.</div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section>
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3531.984!2d85.3185!3d27.7172!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39eb190a5a8c1f8b%3A0x5f42b55e03b7f0c4!2sIslington%20College!5e0!3m2!1sen!2snp!4v1620000000000!5m2!1sen!2snp"
            width="100%" height="380" style="border:0; display:block;" allowfullscreen="" loading="lazy" title="Islington College Location">
    </iframe>
  </section>

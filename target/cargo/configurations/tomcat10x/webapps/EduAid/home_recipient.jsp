...
<head>
  ...
  <title>Recipient Home – EduAid</title>
...
<main>
  <div class="container">
    ...
    <div class="hero">
      ...
      <p>You are logged in as a <strong>Recipient</strong>. Discover free educational resources donated just for you.</p>
      <a href="${pageContext.request.contextPath}/user/dashboard" class="btn-dashboard">
        <i class="fas fa-tachometer-alt"></i> Go to Recipient Dashboard →
      </a>
    </div>

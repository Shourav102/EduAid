...
<main>
  <div class="container">
    ...
    <div class="hero">
      ...
      <p>You are logged in as a <strong>Donor</strong>. Share your digital resources and help students learn.</p>
      <a href="${pageContext.request.contextPath}/user/dashboard" class="btn-dashboard">
        <i class="fas fa-tachometer-alt"></i> Go to Donor Dashboard →
      </a>
    </div>
